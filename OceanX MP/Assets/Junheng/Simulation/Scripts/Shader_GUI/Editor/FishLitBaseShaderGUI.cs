...
namespace OceanX
{
    ...
    /// </summary>
    public abstract class FishLitBaseShaderGUI : ShaderGUI
    {
        ...
        protected enum Expandable
        {
            ...
            /// <summary>
            /// Properties for the fish swimming motion.
            /// </summary>
            FishSwimming = 1 << 4
        }
        ...
        public enum BlendMode
        {
            ...
            /// <summary>
            /// Use this for pre-multiply blend mode.
            /// </summary>
        ...
        protected class Styles
        {
            ...
            public static readonly GUIContent cullingText = EditorGUIUtility.TrTextContent("Render Face",
                "Specifies which faces to cull from your geometry. Front culls front faces. Back culls back faces. None means that both sides are rendered.");
        ...
        /// <summary>
        /// Used to sure that needed setup (keywords/render queue) are set up when switching some existing material to a universal shader.
        /// </summary>
        ...
        public virtual void FindProperties(MaterialProperty[] properties)
        {
            ...
            // ShaderGraph Lit and Unlit sub-targets only
            ...
            // The following are not mandatory for shader graphs (it's up to the user to add them to their graph)
        ...
        public override void OnGUI(MaterialEditor materialEditorIn, MaterialProperty[] properties)
        {
            ...
            // Make sure that needed setup (keywords/render queue) are set up if we're switching some existing
        ...
        internal static void UpdateMaterialSurfaceOptions(Material material, bool automaticRenderQueue)
        {
            ...
            bool isShaderGraph = false;// material.IsShaderGraph();
            ...
            else
            {
                ...
                else
                {
                    ...
                    castShadows = true;// UnityEditor.Rendering.Universal.ShaderGUI.LitGUI.IsOpaque(material);
                }
            }
        ...
        internal static void UpdateMaterialRenderQueueControl(Material material)
        {
            ...
            // If we find another value, add the property set to 1 so we will know that the
            // user has explicitly selected a render queue and we should not override it.
            //
            bool isShaderGraph = false;// material.IsShaderGraph(); // Non-shader graph materials use automatic behavior
        ...
        internal static bool GetAutomaticQueueControlSetting(Material material)
        {
            ...
            // we should not engage automatic behavior until the shader gets re-imported.
            bool automaticQueueControl = true;// !material.IsShaderGraph();
        ...
        public static void SetMaterialKeywords(Material material, Action<Material> shadingModelFunc = null, Action<Material> shaderFunc = null)
        {
            ...
            // Temporary fix for light mapping. TODO: to be replaced with attribute tag.
            ...
            // Not sure what this is used for, I don't see this property declared by any Unity shader in our repository...
        ...
        internal static void SetupMaterialBlendModeInternal(Material material, out int automaticRenderQueue)
        {
            ...
            {
                // no surface type property -- must be hard-coded by the shader graph,
        ...
        /// <summary>
        /// Helper function to draw a pop-up.
        /// </summary>
