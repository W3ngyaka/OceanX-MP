...
float _AutomaticSwimVisualization;
float _CurrentSwimTime;
float _AutomaticSwimSpeed;
float _SideToSideAmplitude;
float _SideToSideOffset;
float _YawRotationAmplitude;
float _YawRotationOffset;
float _TailMaskFalloff;
float _TailRollAmplitude;
float _TailRollOffset;
float _TailWaveLength;
float _TailYawAmplitude;
CBUFFER_END
