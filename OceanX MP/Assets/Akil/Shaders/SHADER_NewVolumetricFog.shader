Shader "Unlit/SHADER_NewVolumetricFog"
{
    Properties
    {
        ...
        _FogSpeed("Fog Movement Speed", Vector) = (0.1, 0.0, 0.1, 0)
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                float3 animatedPos = worldPos * 0.01 * _NoiseTiling + _Time.y * _FogSpeed.xyz;
                float4 noise = _FogNoise.SampleLevel(sampler_FogNoise, animatedPos, 0);
