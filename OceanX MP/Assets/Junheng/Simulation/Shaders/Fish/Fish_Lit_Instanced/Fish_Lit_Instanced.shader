Shader "GameDevBuddies/Fish_Lit_Instanced"
{
    Properties 
    {
        ...
        // Fish Swimming Properties
        [ToggleUI] _VisualizeMask ("Visualize Mask", Float) = 0.0
        [ToggleUI] _AutomaticSwimVisualization ("Automatic Swim Visualization", Float) = 1.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Fish_Lit_Instanced_Input.hlsl"
            #include "Fish_Lit_Instanced_Forward_Pass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Fish_Lit_Input.hlsl"
            #include "Fish_Lit_Instanced_Input.hlsl"
            #include "Fish_Lit_Instanced_Lit_GBuffer_Pass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Fish_Lit_Input.hlsl"
            #include "Fish_Lit_Instanced_Input.hlsl"
            #include "Fish_Lit_Instanced_Shadow_Caster_Pass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Fish_Lit_Input.hlsl"
            #include "Fish_Lit_Instanced_Input.hlsl"
            #include "Fish_Lit_Instanced_Depth_Only_Pass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
           ...
           // -------------------------------------
            ...
            #include "Fish_Lit_Input.hlsl"
            #include "Fish_Lit_Instanced_Input.hlsl"
            #include "Fish_Lit_Instanced_Scene_Picking_Pass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Fish_Lit_Input.hlsl"
            #include "Fish_Lit_Instanced_Input.hlsl"
            #include "Fish_Lit_Instanced_Scene_Selection_Pass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Fish_Lit_Input.hlsl"
            #include "Fish_Lit_Instanced_Input.hlsl"
            #include "Fish_Lit_Instanced_Depth_Normals_Pass.hlsl"
            ENDHLSL
        }
    }
